    ...
    return(
        <div className={"WhatIsUs flexItems flexDisplay column largeGap " + order}>
            ...
            <div className="mainText flexDisplay column largeGap">
                ...
                <p className="subheading flexItems">We offer many services, from Domestic and Commercial window cleaning to Conservatory roof and Gutter Cleaning. Feel free to ENQUIRE if you are unsure about the service you want provided</p>
            </div>
